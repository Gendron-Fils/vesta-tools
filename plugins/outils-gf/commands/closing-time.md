...
## 7. Trancher avec Philippe, puis le rendu final
...
- **👉 À toi** : ce qui reste en attente (reporté, ou en file parce que ça demande un rendu ou l'avocat). Chaque item : quoi, pourquoi ça a besoin de lui en une ligne, et le lien. Si rien n'attend, le dire en une ligne.
